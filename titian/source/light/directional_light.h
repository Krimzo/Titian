...
namespace titian {
	...
	public:
        ...
        dx::DepthView depth_view(uint32_t cascade_index) const;
		dx::ShaderView shader_view(uint32_t cascade_index) const;

		Float4x4 light_matrix(Camera* camera, uint32_t cascade_index) const;
