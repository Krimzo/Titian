...
const int load_types = [&]
{
	...
	{},
	{
		...
		{ cs::fun(&Scene::helper_iterate_meshes), "iterate_meshes" },
		{ cs::fun(&Scene::helper_iterate_animations), "iterate_animations" },
		{ cs::fun(&Scene::helper_iterate_textures), "iterate_textures" },
		{ cs::fun(&Scene::helper_iterate_materials), "iterate_materials" },
		{ cs::fun(&Scene::helper_iterate_shaders), "iterate_shaders" },
		{ cs::fun(&Scene::helper_iterate_entities), "iterate_entities" },
