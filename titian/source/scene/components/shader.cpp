...
titian::Shader::Shader( ShaderType type )
    : shader_type( type )
{
    switch ( type )
    {
...
void titian::Shader::deserialize( Serializer const& serializer )
{
...
void titian::Shader::reload_for_material()
{
    ...
    static Vector<dx::LayoutDescriptor> vertex_layout_descriptors = {
