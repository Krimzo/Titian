...
std::set<std::string> packager::list_files(const std::string_view& dir)
{
...
bool packager::create_package(const std::string_view& input_dir, const std::string& output_file)
{
...
bool packager::open_package(const std::string& input_file)
{
