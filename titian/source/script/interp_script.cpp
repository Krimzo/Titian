...
void titian::InterpScript::load_engine_parts()
{
	m_engine->new_usertype<Int2>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Int2, Int2, operator-, const Int2&),
	...
	m_engine->new_usertype<Float2>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Float2, Float2, operator-, const Float2&),
	...
	m_engine->new_usertype<Float3>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Float3, Float3, operator-, const Float3&),
	...
	m_engine->new_usertype<Float4>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Float4, Float4, operator-, const Float4&),
	...
	m_engine->new_usertype<Complex>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Complex, Complex, operator-, const Complex&),
	...
	m_engine->new_usertype<Quaternion>(
		...
		sl::meta_function::subtraction, CONST_METHOD(Quaternion, Quaternion, operator-, const Quaternion&),
