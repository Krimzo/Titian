...
void titian::GUISectionEntityProperties::display_entity_info( Scene& scene, StringRef const& entity_name, Entity& entity )
{
...
void titian::GUISectionEntityProperties::edit_entity_animation( Scene& scene, Entity& entity )
{
    ...
    {
        String filter = gui_input_continuous( "Search###EntityPropsMesh" );
        if ( im::Selectable( "/", bound_animation == "/" ) )
            bound_animation = "/";

        for ( auto& [name, animation] : scene.animations )
        {
...
void titian::GUISectionEntityProperties::edit_entity_material( Scene& scene, Entity& entity )
{
    ...
    auto& bound_material = entity.material_name;
    if ( im::BeginCombo( "Bound Material", bound_material.data() ) )
    {
        String filter = gui_input_continuous( "Search###EntityPropsMaterial" );
...
{
    static Map<px::PxGeometryType::Enum, String> possible_geometries = {
