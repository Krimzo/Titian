...
titian::String titian::format_path( fs::path const& path )
{
    return "[" + fs::absolute( path ).string() + "]";
}

titian::String titian::ltrim( StringRef const& source, str t )
{
    String data{ source };
...
titian::String titian::rtrim( StringRef const& source, str t )
{
    String data{ source };
...
titian::String titian::trim( StringRef const& source, str t )
{
    return ltrim( rtrim( source, t ), t );
}

bool titian::str_find( StringRef const& haystack, StringRef const& needle )
{
