...
// Loading
java::class_data java::read_class_data(const std::string& path)
{
	FILE* file = nullptr;
...
jclass java::load_eternal_class(const class_data& data)
{
	return load_class(nullptr, data);
}

jclass java::load_class(jobject loader, const class_data& data)
{
