...
titian::LitPass::LitPass(GameLayer* game_layer, RenderLayer* render_layer)
    : RenderPass(game_layer)
{
    this->render_layer = render_layer;
}

bool titian::LitPass::is_renderable() const
{
    return true;
}

titian::StatePackage titian::LitPass::get_state_package()
{
...
void titian::LitPass::render_self(StatePackage& package)
{
    RenderStates* render_states = &render_layer->states;
